...
class Actuators: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        breadboard.setOnClickListener {
            ...
            val intent1= Intent(this, Motor::class.java)
        ...
        jumperwire1.setOnClickListener {
            ...
            val intent2= Intent(this, Buzzer::class.java)
        ...
        rgbleds.setOnClickListener {
            ...
            val intent3= Intent(this, LCD::class.java)
        ...
        led0.setOnClickListener {
            ...
            val intent4= Intent(this, LCDI2C::class.java)
