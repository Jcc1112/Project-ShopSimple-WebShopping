...
class Communication_Modules: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.communication__modules)
        ...
        breadboard.setOnClickListener {
            ...
            val intent1= Intent(this, ESP::class.java)
        ...
        jumperwire1.setOnClickListener {
            ...
            val intent2= Intent(this, hc05::class.java)
        ...
        rgbleds.setOnClickListener {
            ...
            val intent3= Intent(this, GPS::class.java)
        ...
        led0.setOnClickListener {
            ...
            val intent4= Intent(this, RF::class.java)
